...
$echo = '<div class="registration-render.php">
                <h3>Войти</h3>
                <form method="post" class="forum-authentication" action="authication-render.php">
                    ...
                    <a href="registration-user.php">Зарегистрироваться</a>
                </form>
            </div>';
?>
...
<head>
    ...
    <title>Авторизация | Интернет магазин текстильной продукции</title>
