                ...
                <div class="menu" scrolling="no">
                    ...
                    <div class="menu-items" scrolling="no">
                        <ul>
                            ...
                            <li><a href="site-pages/authication-user.php">Продукция</a></li>
                            <li><a href="site-pages/authication-user.php">Услуги</a></li>
                            <li><a href="site-pages/authication-user.php">О нас</a></li>
                            <li><a href="site-pages/authication-user.php">Войти</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="article-header-2">
                            <div class="article-text">
                                ...
                                <div class="information-products">
                                    ...
                                    <a href="site-pages/authication-user.php" class="button-buy">Купить</a>
                                </div>
                            </div>
                        </div>                
                    </div>
